...
$db_create_booking =  array(
     'booking' =>  array(
        ...
        'fk_table' => array(
            array(
                'table' => array('table_name'=>'customer', 'type' => 'node', 'main_parent' => 'booking' , 'select2' => 'customer_name',
                'fields_to_show' => array(
        ...
        array(
            ...
            'fk_table' => array(
                array(
                    'table' => array('table_name'=>'product', 'type' => 'node', 'main_parent' => 'booking', 'select2' => 'product_name')
                ),
                array(
                    'table' => array('table_name'=>'location', 'type' => 'node', 'main_parent' => 'booking', 'select2' => 'location_name')
                ),
             array(
                    'table' => array('table_name'=>'group', 'type' => 'node', 'main_parent' => 'booking', 'select2'=> 'group_name'),
                    'child_table' => array(
                        array(
