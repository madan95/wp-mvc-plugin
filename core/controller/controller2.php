  ...
  public function create_input_select2($data){
    ...
    ?>
      <label for="id_label_single">
        ...
        <select class="js-select-<?php echo $data['unique_id'] ?>  form-control" id="id_label_single" style="width: 75%">
            <option value="1">Someon</option>
            <option value="1">Someon</option>
    ...
    $('.js-select-[<?php echo $data['unique_id']?>]').select2({
      placeholder: 'Seacrh ',
      ajax:{
        url: '<?php echo $data['ajax_url'] ?> ',
        dataType: 'json',
